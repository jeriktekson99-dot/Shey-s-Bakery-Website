          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {[1, 2, 3, 4].map((n) => (
              <div key={n} className="flex flex-col animate-pulse">
                <div className="aspect-square w-full rounded-2xl bg-[#eadecc]/60 border-2 border-[#542515]/20 shadow-[0px_6px_0px_rgba(84,37,21,0.1)]" />
                <div className="h-5 bg-[#eadecc] rounded-md mt-4 w-3/4" />
                <div className="h-4 bg-[#eadecc] rounded-md mt-2 w-1/3" />
                <div className="h-10 bg-[#eadecc]/70 rounded-full mt-4 w-full" />
              </div>
            ))}
          </div>
        ) : (
